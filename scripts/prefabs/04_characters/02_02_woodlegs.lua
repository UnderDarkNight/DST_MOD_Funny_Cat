...
local master_postinit = function(inst)
    ...
    -- inst.talksoundoverride = "moonstorm/characters/woodlegs/talk_LP"

	inst.soundsname = "woodie"
    -- inst.talk_sound = "dontstarve/characters/woodie/talk_LP"
	
	-- 三维	
	inst.components.health:SetMaxHealth(TUNING[string.upper("woodlegs").."_HEALTH"])
	inst.components.hunger:SetMax(TUNING[string.upper("woodlegs").."_HUNGER"])
	inst.components.sanity:SetMax(TUNING[string.upper("woodlegs").."_SANITY"])
