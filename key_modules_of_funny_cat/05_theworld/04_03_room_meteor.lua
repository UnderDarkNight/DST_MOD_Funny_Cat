...
AddPrefabPostInit("world",function(inst)
    ...
    inst:ListenForEvent("map_room_indicator_inited",function(_,Indicator)
        inst:DoStaticTaskInTime(math.random(1,10),function()
                if Indicator:GetType() ~= "METEOR" then
                    return
                end
                ...
                --- 
                    local cmd_table = {
                        ["moon_fissure"] = math.random(2,5),
                        ["moon_tree"] = math.random(30,60),
                        ["hotspring"] = math.random(0,5),
                        ["moonglass_rock"] = math.random(10,20),
                        ["sapling_moon"] = math.random(0,10),
                    }
