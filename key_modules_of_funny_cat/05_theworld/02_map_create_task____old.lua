            ...
            for temp_tile_x = 1, map_width, 1 do
                for temp_tile_y = 1, map_height, 1 do
                    if all_map_tile_data[temp_tile_x][temp_tile_y] == nil then
                        ...
                        -- 
                        TheWorld.Map:SetTile(temp_tile_x,temp_tile_y,1)
                        -- print("remove tile ",temp_tile_x,temp_tile_y)
                            -- table.insert(task_fn_data,{temp_tile_x,temp_tile_y,1})
                            -- funny_cat_SetTile(temp_tile_x,temp_tile_y,1)
                    else
                        ...
                        TheWorld.Map:SetTile(temp_tile_x,temp_tile_y,tile_type)
                            --print("set tile ",temp_tile_x,temp_tile_y,tile_type,tile_type)
                            -- table.insert(task_fn_data,{temp_tile_x,temp_tile_y,tile_type})
                            -- funny_cat_SetTile(temp_tile_x,temp_tile_y,tile_type)
