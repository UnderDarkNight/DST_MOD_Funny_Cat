...
AddPrefabPostInit("world",function(inst)
    ...
    inst:ListenForEvent("map_room_indicator_inited",function(_,Indicator)
        inst:DoStaticTaskInTime(math.random(1,10),function()
            ...
            if Indicator:GetType() ~= "DIRT" then
                return
            end
            ...
            ---
                local cmd_table = {
                    ["cactus"] = math.random(2,20),
                    ["oasis_cactus"] = math.random(5,10),
                    ["lava_pond"] = math.random(5,10),
                    ["marsh_bush"] = math.random(5,10),
                    ["houndmound"] = math.random(5,10),
                    ["scorched_skeleton"] = math.random(0,5),
                }
