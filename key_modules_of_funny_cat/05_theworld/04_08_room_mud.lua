    ...
    inst:ListenForEvent("map_room_indicator_inited",function(_,Indicator)
        inst:DoStaticTaskInTime(math.random(1,10),function()
            ...
            --- 石笋( "stalagmite_tall""stalagmite_tall_full""stalagmite_tall_med""stalagmite_tall_low" )
                local cmd_table = {
                    ["cave_fern"] = math.random(20,30),
                    ["monkeybarrel"] = math.random(0,10),
                    ["stalagmite_tall"] = math.random(5,10),
                    ["stalagmite_tall_full"] = math.random(5,10),
                    ["stalagmite_tall_med"] = math.random(5,10),
                    ["stalagmite_tall_low"] = math.random(5,10),
                }
